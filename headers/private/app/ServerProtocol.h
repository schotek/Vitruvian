...
enum {
	...
	// Edge snap (drag window to a screen edge)
	AS_SET_EDGE_SNAP_ENABLED,
	AS_GET_EDGE_SNAP_ENABLED,
	AS_SET_EDGE_SNAP_MODIFIER,
	AS_GET_EDGE_SNAP_MODIFIER,
	AS_SET_EDGE_SNAP_SENSITIVITY,
	AS_GET_EDGE_SNAP_SENSITIVITY,
