...
string_for_message_code(uint32 code)
{
	switch (code) {
		...
		CODE(AS_SET_EDGE_SNAP_ENABLED);
		CODE(AS_GET_EDGE_SNAP_ENABLED);
		CODE(AS_SET_EDGE_SNAP_MODIFIER);
		CODE(AS_GET_EDGE_SNAP_MODIFIER);
		CODE(AS_SET_EDGE_SNAP_SENSITIVITY);
		CODE(AS_GET_EDGE_SNAP_SENSITIVITY);
		CODE(AS_GET_MOUSE);
